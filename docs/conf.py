...
tempo_eval_version = SourceFileLoader('tempo_eval.version',
                                      '../tempo_eval/version.py').load_module()
version = tempo_eval_version.short_version
release = tempo_eval_version.version
...
# link to other projects' docs using extension sphinx.ext.intersphinx
intersphinx_mapping = {'python': ('https://docs.python.org/3', None),
                       'pygal': ('http://www.pygal.org/en/stable/', None),
                       ...
                       'jams': ('http://jams.readthedocs.io/en/stable/', None),
                       }
